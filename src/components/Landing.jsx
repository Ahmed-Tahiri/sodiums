    ...
    return (<>
        <section className="landingSection">
            <div className='weaponImageContainer'>
                <img data-aos='zoom-in-left' className='sniper' src={sniper} alt='Sniper Image' />
                <img data-aos='zoom-in-left' className='pistol' src={pistol} alt='Pistol Image' />
                <img data-aos='zoom-in-right' className='pistolSp' src={pistolSp} alt='Pistol Image' />
                <img data-aos='zoom-in-right' className='AR' src={AR} alt='Assault Rifle Image' />
            </div>
            <div className='landingMainContent'>
                <img data-aos='zoom-in' className='landingMainImg' src={sodiumLogo} alt='Sodium Logo' />
