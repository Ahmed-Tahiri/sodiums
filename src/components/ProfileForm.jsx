      ...
      <form className="idsForm" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="inputContainer">
          ...
          <input
            ...
            id="clashGGId"
            name="clashGGId"
            value={formData.clashGGId}
            onChange={handleChange}
          />
        </div>
        <button type="submit" className="idFormBtn">
          Save and Verify
        </button>
      </form>
    </>
